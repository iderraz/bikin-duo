...
<section id="serviceCreate" class="container">
    ...
    <form class="container d-flex flex-column w-75" action="{{route('service.store')}}" enctype="multipart/form-data" method="post">
        @csrf
